...
program
	...
	.option(
		"--widget-only",
		"Skip running npm ci in the installed widget directory"
	)
...
program
	...
	.option(
		"--widget-only",
		"Skip running npm ci in the updated widget directory"
	)
	.option("--version <version>", "Specify a version or dist-tag to update to")
	.action(async (pkg: string, options) => {
		await updateWidget(pkg, {
...
program
	...
	.option(
		"-n, --size <size>",
		"Maximum number of npm results to fetch (default: 15)"
	)
	.option(
		"--github-list",
		"Include results from a curated GitHub list when available"
	)
...
program
	.command("dev-setup")
	.description(
		"Download and set up the local development environment for Experience Builder widget development"
	)
	.option(
		"--latest",
		"Download the latest version of Experience Builder Developer Edition"
	)
	.option(
		"-v, --version <version>",
		"Specify a version of Experience Builder Developer Edition to download"
	)
	.action(async (options) => {
